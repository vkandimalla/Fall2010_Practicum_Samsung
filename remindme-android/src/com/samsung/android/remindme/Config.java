...
import com.samsung.remindme.allshared.AllConfig;

/**
 * Configuration settings for the Android client.
 */
public class Config extends AllConfig {
    public static final String SERVER_BASE_URL = "http://remindme-android.appspot.com";
    public static final String SERVER_RPC_URL = SERVER_BASE_URL + "/remindmerpc";
    ...
    public static String makeLogTag(Class cls) {
        String tag = "RemindMe_" + cls.getSimpleName();
